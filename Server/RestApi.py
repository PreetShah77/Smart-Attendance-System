...
def add_manual_entry(docker_response,state,duration_recognition):
            ...
            if similarity > 0.90:
                ...
                for doc in emp_data_query:
                    if doc.exists:
                        ...
                        break  # Assuming 'Emp_id' is un    ique, we break after getting the first matching document.
                ...
                attendance_sheet.update_cell(next_empty_row,6,duration_recognition)
                arr.append(Emp_id)
                print(arr)
...
def recognizeFace(encodedFaceImage:str):
    ...
    headers = {'Content-Type': 'application/json', 'x-api-key': "bf922bcc-40e3-442e-93f5-03e1e6f58720"}
...
def face_check():
    ...
    try:
        ...
        if LivelynessData["face"] == "Real Face":
            ...
            e=add_manual_entry(recognizeFaceResultDict,status,duration_recognize)
